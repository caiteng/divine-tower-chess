...
export class MainMenuController extends Component {
  ...
  public initialize(): void {
    ...
    this.makeLabel('Title', '角斗场：试炼之环', 0, 176, 760, 36, new Color(248, 250, 252, 255));
    this.makeLabel('Subtitle', '2D 小队实时指挥战斗原型', 0, 132, 640, 16, new Color(148, 163, 184, 255));
    this.makeLabel('Tagline', '点击开始后选择难度和初始职业，再进入准备阶段与实时指挥战斗。', 0, 96, 700, 14, new Color(191, 219, 254, 255));

    this.makeMenuButton('StartButton', '开始', 0, 28, new Color(21, 128, 61, 255), () => this.onStart?.());
    this.makeMenuButton('LoadButton', '载入', 0, -30, new Color(37, 99, 235, 255), () => this.onLoadRequested?.());
    this.makeMenuButton('SettingsButton', '设置', 0, -88, new Color(71, 85, 105, 255), () => this.showPanel('settings'));
    this.makeMenuButton('CreditsButton', '鸣谢', 0, -146, new Color(120, 53, 15, 255), () => this.showPanel('credits'));
